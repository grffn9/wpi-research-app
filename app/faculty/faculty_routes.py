...
from app.faculty.faculty_forms import MajorForm, ResearchPositionForm, CourseForm, ProgrammingLanguageForm, ResearchTopicForm
from app import db
...
def require_faculty():
    return current_user.is_authenticated and current_user.user_type == "Faculty"
